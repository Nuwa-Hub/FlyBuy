...
<body>
    ...
    <!-- <div class="popup-form" id="popup-form">
        ...
        <div class="pdf">
            ...
            <label for="fruit1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
