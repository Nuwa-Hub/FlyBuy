...
try {
    ...
    function sendMail($clientEmail, $type, $additionalData){
        ...
        if($type == 'signup'){
            ...
            $mail->Body    = "You have successfully created your Flybuy account. Click <a href='http://127.0.0.1/FlyBuy/emailVerified.php?vkey=$vkey&table=$table'>here</a> to verify your email";
        }
